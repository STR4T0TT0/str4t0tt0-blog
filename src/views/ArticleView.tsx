...
export default function ArticleView() {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      setCountdown((s) => {
        if (s <= 1) { clearInterval(id); window.location.assign(backTo); return 0; }
        return s - 1;
      });
    }, 1000);
          ...
          {notFound ? (
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link to={backTo} className="inline-flex items-center gap-2 text-sm text-white/80 hover:text-white underline underline-offset-2">
