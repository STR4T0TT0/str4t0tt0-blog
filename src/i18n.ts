...
i18n
  ...
  .init({
    lng: initialLang(),
    fallbackLng: 'en',
    ns: ['common','home','blog','footer','menu'], // namespaces à mettre a jour a chaque ajout de JSON
    defaultNS: 'common',
    resources: {
      ...
      en: { common: en_common, home: en_home, blog: en_blog, footer: en_footer, menu: en_menu },
      fr: { common: fr_common, home: fr_home, blog: fr_blog, footer: fr_footer, menu: fr_menu },
      it: { common: it_common, home: it_home, blog: it_blog, footer: it_footer, menu: it_menu }
    },
